		...
		<div class="stack expansion">
			<div class="row-fluid normal-mode active">
				<div class="span2 aside">
					<div class="home-wrap">
						<a href="paper/index.jsp" class="go-home"> <i
							class="glyphicon glyglyphicon-home"></i> <span>回首页</span>
						</a>
					</div>
					<div id="notes-list">
						<div id="new-note">
							<a href="javascript:void(0);" class="new-note-link"> <i
								class="glyphicon glyphicon-plus"></i> <span class="win-text">新建文章</span>
							</a>
						</div>
						
						<ul class="nav nav-list notes ui-sortable">
							<c:forEach var="SaveArticlelist" items="${SaveArticlelist}">
								<li class="one-note active" id="xinjianwz${SaveArticlelist.id}">
									<p class="abbreviate"></p> <a href="javascript:void(0)"
									onclick="clickTitle(${SaveArticlelist.id})" class="note-list title">
									<span id="xiugaititle${SaveArticlelist.id}">${SaveArticlelist.articlename}</span>
									</a>
									<a href="javascript:void(0)" onclick="Updatecotent(${SaveArticlelist.id})" class="icon-note"> <i
										class="glyphicon glyphicon-file"></i>
								</a> <a href="javascript:void(0)" onclick="DeleteCotent(${SaveArticlelist.id})" class="share-note dropdown-toggle">
				...
				<div class="span5 main" style="${str}" >
					<form class="note-form markdown">
						...
						<textarea class="text mousetrap" name="note_content"
						...
						<div id="send_success" class="kalamu-image-modal"
							style="display: none;">
							<a class="btn-link" id="send_success_dis"
								href="javascript:void(null)">X</a>
							<div class="modal-header">
								<h3>发表成功</h3>
							</div>
				...
				<div class="span5 preview" style="${str}" >
