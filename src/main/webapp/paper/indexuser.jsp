		...
		<div class="container person">
			<div class="row">
				<div class="col-xs-16 main">
					<div class="main-top">
							<a class="avatar" href="/">
								<img src="${user.img }" style="width: 80px;height: 80px;">
								<!--<img src="${user.img }">-->
							</a>
				...
				<div class="col-xs-7 col-xs-offset-1 aside">
					...
					<a class="function-btn" data-action="start-edit-intro" href="javascript:void(0)" onclick="UpdateHtml()"><i class="iconfont ic-edit-s"></i>编辑</a>
